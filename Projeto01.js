...
if (respostasSIM == 0) {
  ...
  console.log(
    "Você falhou, mas ainda conseguiu atravessar o rio de crocodilos"
  );
} else if (respostasSIM == 3) {
  console.log(
    "Você chegou perto de resgastar a princesa, mas acaba falhando por pouco."
  );
